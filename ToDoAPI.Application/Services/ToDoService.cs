...
namespace ToDoAPI.Application.Services
{
    public class ToDoService : IToDoService
    {
        ...
        public async Task<ToDo> CreateAsync(CreateToDoDto input) => await _repo.CreateAsync(input);
        public async Task<ToDo?> UpdateAsync(int id, UpdateToDoDto input) => await _repo.UpdateAsync(id, input);
